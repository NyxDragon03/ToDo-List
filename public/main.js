...
angular.module('angularToDo', [])
    .controller('mainController',['$scope', '$http', function($scope, $http) {
        ...
        $http.get('https://to-do-list-amber-five.vercel.app/api/todos')
        ...
        $scope.createToDo = function(){
            if($scope.formData.text){ //validar que el campo no esté vacío
                $http.post('https://to-do-list-amber-five.vercel.app/api/todos', $scope.formData)
                .then(function(response){
                    $scope.formrData = {};
                    $scope.todos = response.data;
                    console.log(response.data);
        ...
        $scope.deleteToDo = function(id){
            $http.delete('https://to-do-list-amber-five.vercel.app/api/todos/'+ id)
            .then(function(response){
                $scope.todos = response.data;
                console.log(response.data);
            })
